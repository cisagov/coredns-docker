...
issue](https://github.com/cisagov/megazord-coredns-redirector-docker/issues) in this
...
request](https://github.com/cisagov/megazord-coredns-redirector-docker/pulls), you will
...
```console
cd megazord-coredns-redirector-docker
pyenv virtualenv <python_version_to_use> megazord-coredns-redirector-docker
pyenv local megazord-coredns-redirector-docker
